...
void test_codec_config(void** state)
{
    ...
    codec_config_tc tc[] = {
        ...
        { .name = "name",
            .value = "foo",
            .offset_value = offsetof(ABCodecInstance, name),
            .offset_int_value = 0 },
        { .name = "model",
            .value = "flexray",
        ...
        { .name = "mode",
            .value = "pop",
            .offset_value = offsetof(ABCodecInstance, mode),
            .offset_int_value = 0 },
        { .name = "pwr",
            .value = "on",
...
void test_codec_stat(void** state)
{
    ...
    codec_stat_tc tc[] = {
        ...
        { .index = 10, .name = "name", .value = "foo" },
        { .index = 11, .name = "model", .value = "flexray" },
        { .index = 12, .name = "mode", .value = "pop" },
        { .index = 13, .name = "pwr", .value = "on" },
